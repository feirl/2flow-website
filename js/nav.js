...
(function () {
  ...
  var ICONS = {
    ...
    difference:    '<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>',
    stories:       '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',
    platform:      '<polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/>',
    integrations2: '<circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/>',
    shopify2:      '<path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/>',
    team:          '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',
    tour:          '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>',
    helpfaq:       '<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/>',
  };
  ...
  var WHY_LINKS = [
    { href: B + '/why-2flow/our-difference',   icon: 'difference',    label: 'Our Difference',       desc: 'Why brands choose 2Flow over a generic 3PL' },
    { href: B + '/why-2flow/customer-stories', icon: 'stories',       label: 'Customer Stories',      desc: 'Real results from brands we&apos;ve scaled' },
    { href: B + '/why-2flow/platform',         icon: 'platform',      label: 'Our Platform',          desc: 'Live WMS, real-time dashboards, full visibility' },
    { href: B + '/why-2flow/integrations',     icon: 'integrations2', label: 'Integrations',          desc: 'Shopify, WooCommerce, Amazon and more' },
    { href: B + '/why-2flow/shopify',          icon: 'shopify2',      label: 'Shopify Specialists',   desc: 'Native Shopify integration with same-day sync' },
    { href: B + '/why-2flow/meet-the-team',    icon: 'team',          label: 'Meet the Team',         desc: 'The people behind your fulfilment operation' },
    { href: B + '/why-2flow/virtual-tour',     icon: 'tour',          label: 'Visit our Dublin Hub',  desc: 'Take a virtual tour of our Dublin warehouse' },
    { href: B + '/faqs/',                      icon: 'helpfaq',       label: 'FAQs',                  desc: 'Common questions about working with 2Flow' },
  ];
  ...
  function buildWhyMega() {
    ...
    for (var i = 0; i < WHY_LINKS.length; i++) {
      var l = WHY_LINKS[i];
      items += '<a href="' + l.href + '" class="mega-item' + active(l.href) + '">' +
        '<div class="mega-item-icon navy-bg">' + icon(l.icon) + '</div>' +
        '<div class="mega-item-text"><h4>' + l.label + '</h4><p>' + l.desc + '</p></div>' +
        '</a>';
    }
    return '<div id="whyMega" class="mega-menu">' +
      '<div class="mega-inner why-grid">' + items + '</div>' +
      '</div>';
  }
